...
<div class="container-fluid" style="padding: 0px">
        ...
        <div class="row" style="min-height: 200px; display:flex">
                ...
                <div class="row" style="min-height: 200px; display:flex; background-image:url(public/images/bannersfinal/11.png); background-repeat:no-repeat; background-position:center;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h4 style="font-size:30px;font-width:300px;">Muffins & Cupcakes</h4><br>
