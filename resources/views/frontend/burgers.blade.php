...
<div class="container-fluid" style="padding: 0px">
        ...
        <div class="row" style="min-height: 200px; display:flex">
                ...
                <div class="row" style="min-height: 200px; display:flex;background-image:url(public/images/Banners/6.png); background-repeat:no-repeat; background-position:center;">
