        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h4 style="font-size:30px;font-width:300px;">Mandarin Juice</h4><br>
            ...
            <div class = "row">
                <div class="col-md-3">
                    <div class = "img " style="margin-top: 40px; margin-bottom: 20px">
                      <img src="public/images/Beverages/mandarin.jpg" class="img-fluid product-grid__img" alt="Cake img">
