...
<div class="container-fluid" style="padding: 0px">
        ...
        <div class="row" style="min-height: 200px; display:flex">
                ...
                <div class="row" style="min-height: 200px; display:flex; background-image:url(public/images/bannersfinal/1.png); background-repeat:no-repeat; background-position:center;">
    ...
    <section id = "img-sec" style="padding-top:60px;padding-bottom:30px; " >
        <div class="container">
            ...
            <div class="col-md-12 text-center">
                    <h4 style="font-size:30px;font-width:300px;">Birthday Cakes for Children</h4><br>
