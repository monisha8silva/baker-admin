				...
				<div class="card-body">
					<div class="card-content p-2">
						<div class="text-center">
							<img src="<?php echo asset('back/assets/assets/images/logo-icon.png');?>" alt="logo icon">
						</div>
						...
						@endif
						<form action="/owner_register" method="post">{{ csrf_field() }}
							...
							<div class="form-group">
								...
								<div class="position-relative has-icon-right">
									<input type="text" id="exampleInputPassword" class="form-control input-shadow" placeholder="Choose Password" name="confirm_password">
									<div class="form-control-position">
										<i class="icon-lock"></i>
									</div>
								</div>
