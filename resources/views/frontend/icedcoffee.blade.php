...
<div class="container-fluid" style="padding: 0px">
    ...
    <section id = "img-sec" style="margin-top: 40px; margin-bottom: 20px">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h4 style="font-size:30px;font-width:300px;">Iced Coffee</h4><br>
        ...
        <div class = "container">
            <div class = "row">
                <div class="col-md-3">
                    <div class = "img " style="margin-bottom:35px!important;">
                      <img src="public/images/Beverages/coffee.jpg" class="img-fluid product-grid__img" alt="Cake img">
