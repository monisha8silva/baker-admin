            ...
            <div class = "row">
                <div class="col-md-3">
                    <div class = "img " style="margin-top: 40px; margin-bottom: 20px">
                      <img src="public/images/Full cakes/cake/CHICKEN PIE.jpg" class="img-fluid product-grid__img" alt="Cake img">
                ...
                <div class="col-md-3">
                    <div class = "img" style="margin-bottom:10px!important;">
                      <img src="public/images/Full cakes/cake/CHICKEN SANDWICH.jpg" class="img-fluid product-grid__img"  alt="Cake img">
                    </div>
                    
                    <!-- <div class="img-title text-center"  style="margin:10px 0;">
                        <h5>Signature Cakes</h5>
                    </div> -->
                    <div class = "img-name text-center"  style="margin-top:30px;">
                        <h5> Chicken Pie</h5>
                    </div>
                    <div class="cake-price text-center">   
                        <h6>LKR 1000</h6>        
                ...
                <div class="col-md-3">
                    <div class = "img" style="margin-bottom:10px!important;">
                      <img src="public/images/Full cakes/cake/CHICKEN PIE 2.jpg" class="img-fluid product-grid__img" alt="Cake img">
                    </div>
                   
                    <!-- <div class="img-title text-center"  style="margin:10px 0;">
                        <h5>Signature Cakes</h5>
                    </div> -->
                    <div class = "img-name text-center" style="margin-top:25px;">
                        <h5>Chicken Pie</h5>
                    </div>
                    <div class="cake-price text-center">   
                        <h6>LKR 1000</h6>        
                ...
                <div class="col-md-3">
                    <div class = "img" style="margin-bottom:10px!important;" >
                      <img src="public/images/Full cakes/cake/CHICKEN SANDWICH1.jpg"  class="img-fluid product-grid__img" alt="Cake img">
                    </div>
