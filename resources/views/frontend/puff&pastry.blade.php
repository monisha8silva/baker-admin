...
<div class="container-fluid" style="padding: 0px">
        ...
        <div class="row" style="min-height: 200px; display:flex">
                ...
                <div class="row" style="min-height: 200px; display:flex; background-image:url(public/images/Banners/10.png); background-repeat:no-repeat; background-position:center;">
                      <div class="col-md-12" style="text-align: center;margin-top: 5%;margin-bottom: 5%;">
                              <!-- <h3 class="mb-3" style="color: #FFFFFF;text-transform: uppercase;margin-bottom: 2%;">Puff & Pastry</h3> -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h4 style="font-size:30px;font-width:300px;">Puff & Pastry</h4><br>
            ...
            <div class = "row">
                <div class="col-md-3">
                    <div class = "img " style="margin-bottom:10px!important;">
                      <img src="public/images/Full cakes/cake/FISH PATTY(1).jpg" class="img-fluid product-grid__img" alt="Cake img">
                ...
                <div class="col-md-3"> -->
                    <!-- <div class = "img" style="margin-bottom:10px!important;">
                      <img src="public/images/Full cakes/cake/SAMOSA.jpg" class="img-fluid product-grid__img"  alt="Cake img">
                    </div> -->
                    
                    <!-- <div class="img-title text-center"  style="margin:10px 0;">
                        <h5>Signature Cakes</h5>
                    </div> -->
                    <!-- <div class = "img-name text-center"  style="margin-top:60px;">
                        <h5> Chicken Pie</h5>
                    </div>
                    <div class="cake-price text-center">   
                        <h6>LKR 1000</h6>        
