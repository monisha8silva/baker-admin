  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
          ...
          <!--image slider start-->
            ...
            <div class="slider"  style="width:100%; border-radius:0">
                <div class="slides">
                ...
                <div class="slide first">
                    <img id="sliderImg" src="public/images/s-1.jpg" alt="">
                ...
                <div class="slide ">
                    <img id="sliderImg" src="public/images/s-2.jpg" alt="">
                </div>
                <div class="slide">
                    <img id="sliderImg" src="public/images/s-3.jpg" alt="">
                </div>
                ...
                <div class="navigation-manual" style="width:100%">
                    <label for="radio1" class="manual-btn"  style="border-color: #048343"></label>
                    <label for="radio2" class="manual-btn" style="border-color: #048343"></label>
                    <label for="radio3" class="manual-btn" style="border-color: #048343"></label>
                </div>
...
<section id = "img-sec" style="padding-top:60px;padding-bottom:30px; " >
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h4 style="font-size:30px;font-width:300px;">Birthday Cakes</h4><br>
                        <p style="margin-bottom:40px ;"></p>
                    </div>
                </div>
            </div>
...
<section id = "img-sec" style="padding-top:60px;padding-bottom:30px; " >
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h4 style="font-size:30px;font-width:300px;">Desserts</h4><br>
                        <p style="margin-bottom:40px ;"></p>
                    </div>
                </div>
            </div>
